  ...
  return (
    // <AnimatePresence mode="wait">
      <motion.div
        ...
        <div className="flex flex-wrap gap-1 mb-10 justify-items-center justify-start ms-1">
          <MenuDashboard
        ...
        <div className="container columns-2 ms-2">
          <div className="text-black ms-2 me-2">
            ...
            <p className="flex-wrap text-balance">Telepon Kantor: 123 12345</p>
            <p>humas.srg@ap1.co.id</p>
          </div>
          <div className="text-black ms-2 me-2">
            <p>Contact Center : 172</p>
            <p className="flex-wrap text-balance">Saran dan Keluhan : cc172@ap1.co.id</p>
